...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmVtaW5kMTk5MCIsImEiOiJjbGlhdXJ2ZTEwNmJ0M2puMW1lOG5ieHdoIn0.IHjDiTHAW40NImqgFX2aHA';
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: 'http://localhost:4400/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: 'http://localhost:4400/api/v1/users/logout'
          });
        case 3:
          res = _context2.sent;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://localhost:4400/api/v1/users/updateMyPassword' : 'http://localhost:4400/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51NCq8TD0X1ccdRaYdZyz6hTHWz7DtJRdWvEaYdrKA1kd3j2Ws0XnW54NmcuFkMxgakBqKPKcKVPTPCiTObeCmWn000Kn3lOGuu'); // 1) Get checkout session from API
          _context.next = 4;
          return _axios.default.get("http://localhost:4400/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
